...
#define SAMPLE_DEVICE_NAME          "LOP2_NHOM_10"
...
uint8_t sale_off[] = {0x00,0x00,0x35,0x30,0x25,0x20,0x73,0x61,0x6c,0x65};
...
static esp_ble_adv_data_t adv_data = {
    ...
    .max_interval        = 0x40,
    .appearance          = 0x00,
    .manufacturer_len    = sizeof(sale_off),    //TEST_MANUFACTURER_DATA_LEN,
    .p_manufacturer_data =(uint8_t *) sale_off, //test_manufacturer,
    .service_data_len    = 0,
    .p_service_data      = NULL,
...
static const uint8_t char1_name[]  = "Message to MQTT:";
static const uint8_t char2_name[]  = "MQTT topic";
// static const uint8_t char3_name[]  = "Char_3_Short_Notify";
// static const uint8_t char_ccc[2]   = {0x00, 0x00};
static const uint8_t char_value[8] = "Nothing!";
...
static void gap_event_handler(esp_gap_ble_cb_event_t event, esp_ble_gap_cb_param_t *param)
{
    switch (event) {
        ...
        case ESP_GAP_BLE_KEY_EVT:
            ...
            EXAMPLE_DEBUG(EXAMPLE_TAG, "key type");
            // EXAMPLE_DEBUG(EXAMPLE_TAG, "key type = %s",(char *) esp_key_type_to_str(param->ble_security.ble_key.key_type));
            break;
        ...
        case ESP_GATTS_WRITE_EVT:
            if (!param->write.is_prep){
                ...
                if(gatt_db_handle_table[IDX_CHAR_VAL_A] == param->write.handle) {
                    ...
                    // char id[20] = "";
                    // int len = sprintf(id,"%s",(char *)param->write.value);
                    printf("%s\r\n",param->write.value);
                    mqtt_client_publish(mqtt_topic,(char *)param->write.value);
                    // task_ssd1306_display_text(id);
                }
                if(gatt_db_handle_table[IDX_CHAR_VAL_B] == param->write.handle) {
                    ...
                    //     ESP_LOGI(EXAMPLE_TAG, "(3)***** long write success ***** \n");
                    // }
                    memcpy(mqtt_topic,param->write.value,param->write.len);
                }
